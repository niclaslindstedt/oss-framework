...
export const sv: Catalog = {
  ...
  stats: {
    ...
    doneInWindowTo: "{n} avklarade under de 14 dagarna till {date}",
    windowEnd: "Visa de 14 dagarna som slutar",
    windowEndToday: "Idag",
  ...
  settings: {
    ...
    editor: {
      ...
      listTitle: "Nya rader",
      addItemPosition: "Lägg till nya rader",
      addItemPositionHint:
        "Var lägg-till-knappen placerar en ny rad. Enter på en rad lägger alltid nästa rad direkt under den.",
      optionTop: "Överst i listan",
      optionBottom: "Nederst i listan",
    },
    storage: {
