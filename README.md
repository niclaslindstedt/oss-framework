...
| chart math               | `.` and `./charts`       | Pure scales/ticks/paths: `linearScale`, `timeScale`, `bandScale`, `linearTicks`, `timeTicks`, `stackSeries`, `donutArcs`, …                                                                        |
...
| `Intl` wrappers          | `.` and `./format`       | `formatNumber`, `formatCompact`, `formatDate`, `formatRelative`, `formatDuration`, `weekdayNames`, `monthName` — cached, locale-as-parameter.                                                      |
